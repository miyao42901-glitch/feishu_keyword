...
# -*- coding: utf-8 -*-
"""
Update V2 form to use generalSelect like Douyin
"""
...
def update_v2_form():
    """Update V2 form to use generalSelect component"""
...
'''
    ...
    print("V2 form updated successfully!")
    print("Now uses generalSelect component like Douyin!")
    return True
