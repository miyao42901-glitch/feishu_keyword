...
CREATE TABLE IF NOT EXISTS feishu_douyin_results (
    ...
    UNIQUE KEY uq_feishu_douyin_results_task_post (task_id, post_id),
...
CREATE TABLE IF NOT EXISTS feishu_xhs_results (
    ...
    UNIQUE KEY uq_feishu_xhs_results_task_post (task_id, post_id),
...
CREATE TABLE IF NOT EXISTS feishu_wxvideo_results (
    ...
    UNIQUE KEY uq_feishu_wxvideo_results_task_post (task_id, post_id),
...
CREATE TABLE IF NOT EXISTS feishu_mp_results (
    ...
    create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    UNIQUE KEY uq_feishu_mp_results_task_post (task_id, post_id),
