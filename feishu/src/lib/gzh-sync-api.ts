 ...
 * 公众号搜索同步：`POST /api/v1/sync/wxvideo/search-page`

 * 与视频号同路径；请求体无 `note_time`，翻页用 `offset` / `cookies_buffer`。
...
const GZH_SEARCH_PAGE_PATH = '/api/v1/sync/wxvideo/search-page'
